<?php
// email setting //
  $mailto    = "afiqah@asiapacific.com.my"; 
  $bccMail   = "";  // leave it blank as options //
  $from      = "COLD TECH MARKETING SDN BHD";  // Name of the company where this form is belongs.
  $subject   = "COLD TECH MARKETING have enquiry From %name%";
...
/*ACTIVATE CODE FROM HERE IF YOU WANT AUTO RESPONSE
//Auto Response added by waikee
	
//Prepare autoresponder subject
$respond_email = $_POST['User_Email']; //Case Sensitive
$respond_subject = "Auto Response From companyname";
//Prepare autoresponder message
$respond_message = "Dear $p_User_Name!
...
*** This is an automatically response email, please do not reply ***
...
$respond_header = "From: companyname <name@companyname.com.my>";

//Send the message using mail() function
mail($respond_email, $respond_subject, $respond_message, $respond_header);

//DELETE UNTIL HERE IF DONT WANT AUTO RESPONSE */	 
